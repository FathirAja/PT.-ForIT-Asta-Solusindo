    ...
    <div class="row g-4">
      <div class="col-md-5">
        <div class="p-4 border h-100" style="border-radius:6px;">
          ...
          <p><i class="fa-solid fa-envelope text-primary me-2"><a href="mailto:[sales@sid.net.id]" class="footer-link-alt"></i>sales@sid.net.id</li></a></p>
          <p><i class="fa-solid fa-phone text-primary me-2"><a href="https://wa.me/6282119001500" class="footer-link-alt" target="_blank"></i>0821-1900-1500</li></a></p>
